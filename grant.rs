...
//! functionality in Bennani Kernel:
//!
//! ```text,ignore
//!                         ┌──────────────────────────┐
//!                         │ struct Grant<T, ...> {   │
    ...
    ProcessGrant<'a, T, Upcalls, AllowROs, AllowRWs>
{
    ...
    fn new(
        ...
        // common to have over 50 copies of Grant::enter() in a Bennani Kernel kernel (and
    ...
    ///
    /// However, since the example uses `.enter()` on the iteration, Bennani Kernel will
