...
/// Standard errors in Bennani Kernel.
///
...
/// Bennani Kernel 2.0 system call interface, where success payloads and errors are not
...
/// StatusCode in Bennani Kernel) for three reasons:
///
...
///    StatusCode.
///
/// This helper function converts the Bennani Kernel and Rust convention for a
