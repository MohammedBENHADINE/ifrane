...
//! things, or none.
//!
//! Capabilities are the mechanism in Bennani Kernel that provides more granular access.
...
/// well as manage the main scheduler loop in Bennani Kernel. This is needed in a board's
