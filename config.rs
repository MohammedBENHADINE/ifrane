...
//! experiments on generated Bennani Kernel code have confirmed this zero cost in
//! practice.
...
pub(crate) struct Config {
    ...
    // credentials checking, e.g., whether elf2tab and Bennani Kernelloader are generating
...
/// relevant configuration. Notably, this is the only location in the Bennani Kernel
