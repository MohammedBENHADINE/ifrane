//! Components extend the functionality of the Bennani Kernel kernel through a simple
//! factory method interface.

/// A component encapsulates peripheral-specific and capsule-specific
/// initialization for the Bennani Kernel OS kernel in a factory method, which reduces
...
pub trait Component {
    ...
    /// instantiate and initialize part of the Bennani Kernel kernel. This factory method
